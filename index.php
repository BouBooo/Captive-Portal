<!DOCTYPE html>    
    ...
    <div style="margin:50px; margin-left:30px;margin-right:30px" class="container">
    ...
    <form method="post" action="$PORTAL_ACTION$">           
        ...
        <table style="margin-bottom:50px" class="table table-dark">
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input class="form-control" name="auth_pass" type="password">
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input class="form-control" name="accept" type="submit" value="Continue">
            </td>
        </tr>
        </table>
    </form>
    ...
    <form method="post" action="$PORTAL_ACTION$">           
        ...
        <tr>
            ...
            <td>
                <input class="form-control" name="auth_voucher" type="text">
            </td>
        </tr>
        <tr>
            <td>
        ...
        <!--<div style="text-align:center" class ="container">
            ...
            <h4><script>document.write(dateTime)</script></h4>
        </div>-->
    </body>
</html>